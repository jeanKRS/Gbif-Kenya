...
```{r fig-quality-summary, fig.cap="Overall data quality assessment showing the proportion of records with quality flags. The chart illustrates what percentage of records would be retained under a moderate filtering strategy versus flagged for quality issues."}
knitr::include_graphics(here("figures", "data_quality_summary.png"))
```
...
knitr::include_graphics(here("figures", "data_quality_flag_frequencies.png"))
```

Figure 4 illustrates the comparison between different filtering strategies (strict, moderate, and minimal), showing how many records would be retained under each approach.

```{r fig-quality-strategies, fig.cap="Comparison of filtering strategies showing the number of records that would be retained under strict, moderate, and minimal quality filtering approaches. This demonstrates the flexibility of the flagging framework to support different analytical requirements."}
knitr::include_graphics(here("figures", "data_quality_filtering_strategies.png"))
```
